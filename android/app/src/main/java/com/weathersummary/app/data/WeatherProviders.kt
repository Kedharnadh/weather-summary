...
internal class OpenMeteoProvider : WeatherProvider {
    ...
    override suspend fun fetch(lat: Double, lon: Double): WeatherSnapshot {
        ...
        return parseOpenMeteo(Http.get(url))
    }
}

internal fun parseOpenMeteo(json: String): WeatherSnapshot =
    gson.fromJson(json, OmResponse::class.java).toSnapshot()
...
internal class OpenWeatherMapProvider : WeatherProvider {
    ...
    override suspend fun fetch(lat: Double, lon: Double): WeatherSnapshot {
        ...
        return parseOpenWeatherMap(Http.get(url))
    }
}

internal fun parseOpenWeatherMap(json: String): WeatherSnapshot {
    val ow = gson.fromJson(json, OwlResponse::class.java)
    val cur = ow.current
    return WeatherSnapshot(
        current = CurrentWeather(
...
internal class WeatherApiComProvider : WeatherProvider {
    ...
    override suspend fun fetch(lat: Double, lon: Double): WeatherSnapshot {
        ...
        return parseWeatherApiCom(Http.get(url))
    }
}

internal fun parseWeatherApiCom(json: String): WeatherSnapshot {
    val wa = gson.fromJson(json, WaResponse::class.java)
    val cur = wa.current
    return WeatherSnapshot(
        current = CurrentWeather(
...
internal val gson: com.google.gson.Gson = com.google.gson.Gson()
...
internal class WindyProvider : WeatherProvider {
    ...
    override suspend fun fetch(lat: Double, lon: Double): WeatherSnapshot {
        ...
        return parseWindy(Http.postJson(WINDY_URL, body))
    }
}

internal fun parseWindy(json: String): WeatherSnapshot {
